...
from utils.rgbd2pcd import compute_xyz, get_xyz, get_xyz_cpp # D Y?
...
def inverse_warp_cpp(ref_depth, cur_data, R, t, fx, fy, cx, cy):
    ...
    pixel_coords = jt.stack([U_proj_normalized, V_proj_normalized], dim=2).view(b, h, w, 2)  # [B, H, W, 2]
    reprojected_data = jt.nn.grid_sample(cur_data, pixel_coords, align_corners=True)
    return reprojected_data
